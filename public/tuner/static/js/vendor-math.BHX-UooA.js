import { am as typedFunction, an as Complex, ao as Fraction, ap as _extends, aq as Emitter } from "./vendor-base.BHbH-Msk.js";
var DEFAULT_CONFIG = {
  ...
  function _config(options) {
    if (options) {
      if (options.epsilon !== void 0) {
        ...
        var optionsFix = clone$2(options);
      ...
      var prev = clone$2(config2);
      validateOption(options, "matrix", MATRIX_OPTIONS);
      validateOption(options, "number", NUMBER_OPTIONS);
      deepExtend(config2, options);
      var curr = clone$2(config2);
      var changes = clone$2(options);
      emit("config", curr, prev, changes);
      return curr;
    } else {
      return clone$2(config2);
    }
  }
...
function safeNumberType(numberStr, config2) {
  if (config2.number === "bigint") {
    try {
      BigInt(numberStr);
    } catch (_unused) {
      return config2.numberFallback;
    }
  }
  return config2.number;
}
...
var dependencies$P = ["?BigNumber", "?Complex", "?DenseMatrix", "?Fraction"];
var createTyped = /* @__PURE__ */ factory("typed", dependencies$P, function createTyped2(_ref) {
  var {
    BigNumber,
    Complex: Complex2,
    DenseMatrix,
...
PI = new Decimal(PI);
var name$O = "BigNumber";
var dependencies$O = ["?on", "config"];
var createBigNumberClass = /* @__PURE__ */ factory(name$O, dependencies$O, (_ref) => {
  var {
    on,
    config: config2
  } = _ref;
...
var name$N = "Complex";
var dependencies$N = [];
var createComplexClass = /* @__PURE__ */ factory(name$N, dependencies$N, () => {
...
var name$M = "Fraction";
var dependencies$M = [];
var createFractionClass = /* @__PURE__ */ factory(name$M, dependencies$M, () => {
...
var name$L = "Matrix";
var dependencies$L = [];
var createMatrixClass = /* @__PURE__ */ factory(name$L, dependencies$L, () => {
  function Matrix() {
...
function deepForEach$1(array, callback) {
  var skipIndex = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false;
  if (array.length === 0) {
    return;
  }
...
function optimizeCallback(callback, array, name2, isUnary) {
...
var name$K = "DenseMatrix";
var dependencies$K = ["Matrix"];
var createDenseMatrixClass = /* @__PURE__ */ factory(name$K, dependencies$K, (_ref) => {
  var {
    Matrix
  } = _ref;
...
function deepForEach(array, callback) {
  if (isMatrix(array)) {
    ...
    deepForEach$1(array, callback, true);
  }
}
...
var name$J = "isInteger";
var dependencies$J = ["typed"];
var createIsInteger = /* @__PURE__ */ factory(name$J, dependencies$J, (_ref) => {
  var {
    typed
  } = _ref;
  return typed(name$J, {
...
var createIsZero = /* @__PURE__ */ factory(name$I, dependencies$I, (_ref) => {
  var {
    typed,
    equalScalar
  } = _ref;
...
var createIsNaN = /* @__PURE__ */ factory(name$H, dependencies$H, (_ref) => {
  var {
    typed
  } = _ref;
  return typed(name$H, {
...
var createEqualScalar = /* @__PURE__ */ factory(name$G, dependencies$G, (_ref) => {
  ...
  return typed(name$G, {
    ...
    "number, number": function number_number(x, y) {
      return nearlyEqual$1(x, y, config2.relTol, config2.absTol);
    },
    "BigNumber, BigNumber": function BigNumber_BigNumber(x, y) {
      return x.eq(y) || nearlyEqual(x, y, config2.relTol, config2.absTol);
    },
...
var createSparseMatrixClass = /* @__PURE__ */ factory(name$F, dependencies$F, (_ref) => {
  ...
  function _createFromMatrix(matrix, source, datatype) {
    if (source.type === "SparseMatrix") {
      matrix._values = source._values ? clone$2(source._values) : void 0;
...
var createUnaryMinus = /* @__PURE__ */ factory(name$A, dependencies$A, (_ref) => {
  var {
    typed
  } = _ref;
  return typed(name$A, {
...
var name$x = "subtractScalar";
var dependencies$x = ["typed"];
var createSubtractScalar = /* @__PURE__ */ factory(name$x, dependencies$x, (_ref) => {
  var {
    typed
  } = _ref;
  return typed(name$x, {
...
var name$w = "matAlgo11xS0s";
var dependencies$w = ["typed", "equalScalar"];
var createMatAlgo11xS0s = /* @__PURE__ */ factory(name$w, dependencies$w, (_ref) => {
  var {
    typed,
    equalScalar
  } = _ref;
...
var name$v = "matAlgo12xSfs";
var dependencies$v = ["typed", "DenseMatrix"];
var createMatAlgo12xSfs = /* @__PURE__ */ factory(name$v, dependencies$v, (_ref) => {
  var {
    typed,
    DenseMatrix
  } = _ref;
...
var name$u = "matAlgo14xDs";
var dependencies$u = ["typed"];
var createMatAlgo14xDs = /* @__PURE__ */ factory(name$u, dependencies$u, (_ref) => {
  var {
    typed
  } = _ref;
...
var name$t = "matAlgo03xDSf";
var dependencies$t = ["typed"];
var createMatAlgo03xDSf = /* @__PURE__ */ factory(name$t, dependencies$t, (_ref) => {
  var {
    typed
  } = _ref;
...
var name$s = "matAlgo05xSfSf";
var dependencies$s = ["typed", "equalScalar"];
var createMatAlgo05xSfSf = /* @__PURE__ */ factory(name$s, dependencies$s, (_ref) => {
  var {
    typed,
    equalScalar
  } = _ref;
...
var name$r = "matAlgo13xDD";
var dependencies$r = ["typed"];
var createMatAlgo13xDD = /* @__PURE__ */ factory(name$r, dependencies$r, (_ref) => {
  var {
    typed
  } = _ref;
...
var name$q = "matrixAlgorithmSuite";
var dependencies$q = ["typed", "matrix"];
var createMatrixAlgorithmSuite = /* @__PURE__ */ factory(name$q, dependencies$q, (_ref) => {
  var {
    typed,
    matrix
  } = _ref;
...
var name$p = "matAlgo01xDSid";
var dependencies$p = ["typed"];
var createMatAlgo01xDSid = /* @__PURE__ */ factory(name$p, dependencies$p, (_ref) => {
  var {
    typed
  } = _ref;
...
var name$o = "matAlgo04xSidSid";
var dependencies$o = ["typed", "equalScalar"];
var createMatAlgo04xSidSid = /* @__PURE__ */ factory(name$o, dependencies$o, (_ref) => {
  var {
    typed,
    equalScalar
  } = _ref;
...
var name$n = "matAlgo10xSids";
var dependencies$n = ["typed", "DenseMatrix"];
var createMatAlgo10xSids = /* @__PURE__ */ factory(name$n, dependencies$n, (_ref) => {
  var {
    typed,
    DenseMatrix
  } = _ref;
...
var createMultiplyScalar = /* @__PURE__ */ factory(name$m, dependencies$m, (_ref) => {
  var {
    typed
  } = _ref;
...
var name$l = "multiply";
var dependencies$l = ["typed", "matrix", "addScalar", "multiplyScalar", "equalScalar", "dot"];
var createMultiply = /* @__PURE__ */ factory(name$l, dependencies$l, (_ref) => {
  var {
    typed,
    matrix,
    addScalar,
  ...
  return typed(name$l, multiplyScalar, {
...
var name$k = "subtract";
var dependencies$k = ["typed", "matrix", "equalScalar", "subtractScalar", "unaryMinus", "DenseMatrix", "concat"];
var createSubtract = /* @__PURE__ */ factory(name$k, dependencies$k, (_ref) => {
  var {
    typed,
    matrix,
    equalScalar,
...
var name$j = "matAlgo07xSSf";
var dependencies$j = ["typed", "SparseMatrix"];
var createMatAlgo07xSSf = /* @__PURE__ */ factory(name$j, dependencies$j, (_ref) => {
  var {
    typed,
    SparseMatrix
  } = _ref;
...
var createConj = /* @__PURE__ */ factory(name$i, dependencies$i, (_ref) => {
  var {
    typed
  } = _ref;
  return typed(name$i, {
...
var name$h = "concat";
var dependencies$h = ["typed", "matrix", "isInteger"];
var createConcat = /* @__PURE__ */ factory(name$h, dependencies$h, (_ref) => {
  var {
    typed,
    matrix,
...
var name$g = "identity";
var dependencies$g = ["typed", "config", "matrix", "BigNumber", "DenseMatrix", "SparseMatrix"];
var createIdentity = /* @__PURE__ */ factory(name$g, dependencies$g, (_ref) => {
  var {
    typed,
    config: config2,
    matrix,
  ...
  return typed(name$g, {
    ...
    "number | BigNumber, string": function number__BigNumber_string(rows, format2) {
    ...
    "number | BigNumber, number | BigNumber, string": function number__BigNumber_number__BigNumber_string(rows, cols, format2) {
      return _identity(rows, cols, format2);
    },
    Array: function Array2(size) {
      return _identityVector(size);
    },
    "Array, string": function Array_string(size, format2) {
      return _identityVector(size, format2);
    },
    Matrix: function Matrix(size) {
      return _identityVector(size.valueOf(), size.storage());
    },
    "Matrix, string": function Matrix_string(size, format2) {
...
var createSize = /* @__PURE__ */ factory(name$f, dependencies$f, (_ref) => {
  ...
  return typed(name$f, {
    ...
    Array: arraySize,
    string: function string(x) {
      return config2.matrix === "Array" ? [x.length] : matrix([x.length], "dense", "number");
    },
    "number | Complex | BigNumber | Unit | boolean | null": function number__Complex__BigNumber__Unit__boolean__null(x) {
      return config2.matrix === "Array" ? [] : matrix ? matrix([], "dense", "number") : noMatrix();
    }
  });
});
...
var name$e = "format";
var dependencies$e = ["typed"];
var createFormat = /* @__PURE__ */ factory(name$e, dependencies$e, (_ref) => {
  var {
    typed
  } = _ref;
  return typed(name$e, {
...
var name$d = "numeric";
var dependencies$d = ["number", "?bignumber", "?fraction"];
var createNumeric = /* @__PURE__ */ factory(name$d, dependencies$d, (_ref) => {
  var {
    number: _number,
    bignumber,
    fraction
...
var name$c = "divideScalar";
var dependencies$c = ["typed", "numeric"];
var createDivideScalar = /* @__PURE__ */ factory(name$c, dependencies$c, (_ref) => {
  var {
    typed,
    numeric
  } = _ref;
...
var name$b = "equal";
var dependencies$b = ["typed", "matrix", "equalScalar", "DenseMatrix", "concat", "SparseMatrix"];
var createEqual = /* @__PURE__ */ factory(name$b, dependencies$b, (_ref) => {
  var {
    typed,
    matrix,
    equalScalar,
  ...
  return typed(name$b, createEqualNumber({
    typed,
    equalScalar
  }), matrixAlgorithmSuite({
    elop: equalScalar,
...
var createEqualNumber = factory(name$b, ["typed", "equalScalar"], (_ref2) => {
  var {
    typed,
    equalScalar
  } = _ref2;
...
var name$a = "smaller";
var dependencies$a = ["typed", "config", "bignumber", "matrix", "DenseMatrix", "concat", "SparseMatrix"];
var createSmaller = /* @__PURE__ */ factory(name$a, dependencies$a, (_ref) => {
  var {
    typed,
    config: config2,
    bignumber,
  ...
  function bignumSmaller(x, y) {
    return x.lt(y) && !nearlyEqual(x, y, config2.relTol, config2.absTol);
  }
  return typed(name$a, createSmallerNumber({
    typed,
    config: config2
  }), {
...
var createSmallerNumber = /* @__PURE__ */ factory(name$a, ["typed", "config"], (_ref2) => {
  var {
    typed,
    config: config2
  } = _ref2;
  return typed(name$a, {
    "number, number": function number_number(x, y) {
      return x < y && !nearlyEqual$1(x, y, config2.relTol, config2.absTol);
    }
  });
});
var name$9 = "smallerEq";
var dependencies$9 = ["typed", "config", "matrix", "DenseMatrix", "concat", "SparseMatrix"];
var createSmallerEq = /* @__PURE__ */ factory(name$9, dependencies$9, (_ref) => {
  var {
    typed,
    config: config2,
    matrix,
  ...
  return typed(name$9, createSmallerEqNumber({
    typed,
    config: config2
  }), {
    "boolean, boolean": (x, y) => x <= y,
    "BigNumber, BigNumber": function BigNumber_BigNumber(x, y) {
      return x.lte(y) || nearlyEqual(x, y, config2.relTol, config2.absTol);
    },
    "bigint, bigint": (x, y) => x <= y,
    "Fraction, Fraction": (x, y) => x.compare(y) !== 1,
...
var createSmallerEqNumber = /* @__PURE__ */ factory(name$9, ["typed", "config"], (_ref2) => {
  var {
    typed,
    config: config2
  } = _ref2;
...
var name$8 = "larger";
var dependencies$8 = ["typed", "config", "bignumber", "matrix", "DenseMatrix", "concat", "SparseMatrix"];
var createLarger = /* @__PURE__ */ factory(name$8, dependencies$8, (_ref) => {
  var {
    typed,
    config: config2,
    bignumber,
  ...
  function bignumLarger(x, y) {
    return x.gt(y) && !nearlyEqual(x, y, config2.relTol, config2.absTol);
  }
  return typed(name$8, createLargerNumber({
    typed,
    config: config2
  }), {
    "boolean, boolean": (x, y) => x > y,
...
var createLargerNumber = /* @__PURE__ */ factory(name$8, ["typed", "config"], (_ref2) => {
  var {
    typed,
    config: config2
  } = _ref2;
...
var name$7 = "largerEq";
var dependencies$7 = ["typed", "config", "matrix", "DenseMatrix", "concat", "SparseMatrix"];
var createLargerEq = /* @__PURE__ */ factory(name$7, dependencies$7, (_ref) => {
  var {
    typed,
    config: config2,
    matrix,
  ...
  return typed(name$7, createLargerEqNumber({
    typed,
    config: config2
  }), {
    "boolean, boolean": (x, y) => x >= y,
    "BigNumber, BigNumber": function BigNumber_BigNumber(x, y) {
      return x.gte(y) || nearlyEqual(x, y, config2.relTol, config2.absTol);
    },
    "bigint, bigint": function bigint_bigint(x, y) {
      return x >= y;
    },
...
var createLargerEqNumber = /* @__PURE__ */ factory(name$7, ["typed", "config"], (_ref2) => {
  var {
    typed,
    config: config2
  } = _ref2;
...
var name$6 = "max";
var dependencies$6 = ["typed", "config", "numeric", "larger", "isNaN"];
var createMax = /* @__PURE__ */ factory(name$6, dependencies$6, (_ref) => {
  var {
    typed,
    config: config2,
    numeric,
  ...
  function _max(array) {
    ...
    if (typeof res === "string") {
      res = numeric(res, safeNumberType(res, config2));
    }
    return res;
  }
});
var name$5 = "min";
var dependencies$5 = ["typed", "config", "numeric", "smaller", "isNaN"];
var createMin = /* @__PURE__ */ factory(name$5, dependencies$5, (_ref) => {
  var {
    typed,
    config: config2,
    numeric,
  ...
  function _min(array) {
    ...
    if (typeof min2 === "string") {
      min2 = numeric(min2, safeNumberType(min2, config2));
    }
    return min2;
  }
});
var name$4 = "add";
var dependencies$4 = ["typed", "matrix", "addScalar", "equalScalar", "DenseMatrix", "SparseMatrix", "concat"];
var createAdd = /* @__PURE__ */ factory(name$4, dependencies$4, (_ref) => {
  var {
    typed,
    matrix,
    addScalar,
...
function importFactory(typed, load, math, importedFactories) {
  function mathImport(functions, options) {
    ...
    function flattenImports(flatValues2, value2, name3) {
      ...
      } else if (isObject(value2) || isModule(value2)) {
  ...
  function _import(name2, value, options) {
    ...
    if (typed.isTypedFunction(math[name2]) && typed.isTypedFunction(value)) {
      if (options.override) {
    ...
    var isDefined = math[name2] !== void 0;
    var isValuelessUnit = (_math$Unit = math.Unit) === null || _math$Unit === void 0 ? void 0 : _math$Unit.isValuelessUnit(name2);
  ...
  function _importFactory(factory2, options) {
    ...
    var former = (_factory$meta$formerl = (_factory$meta = factory2.meta) === null || _factory$meta === void 0 ? void 0 : _factory$meta.formerly) !== null && _factory$meta$formerl !== void 0 ? _factory$meta$formerl : "";
    var needsTransform = isTransformFunctionFactory(factory2) || factoryAllowedInExpressions(factory2);
    ...
    if (!factory2.meta || factory2.meta.lazy !== false) {
      ...
      if (existing && existingTransform) {
        ...
        if (needsTransform) {
          lazy(withTransform, name2, () => namespace[name2]);
          if (former) lazy(withTransform, former, () => namespace[name2]);
        }
      }
    } else {
      namespace[name2] = resolver();
      if (former) namespace[former] = namespace[name2];
      if (existing && existingTransform) {
        _deleteTransform(name2);
        if (former) _deleteTransform(former);
      } else {
...
export {
  maxDependencies as a,
  multiplyDependencies as b,
  create as c,
  divideDependencies as d,
  equalDependencies as e,
  formatDependencies as f,
  subtractDependencies as g,
  addDependencies as h,
  largerEqDependencies as l,
  minDependencies as m,
  numericDependencies as n,
  smallerEqDependencies as s
};
