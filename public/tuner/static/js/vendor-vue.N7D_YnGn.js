import { i as isBoolean, a as isPlainObject$2, b as assign$2, D as DEFAULT_LOCALE, c as isString$1, d as isArray$2, e as isRegExp, f as isFunction$1, u as updateFallbackLocale, g as inBrowser, h as createCompileError, m as makeSymbol, j as isEmptyObject, k as isObject$1, l as create, n as deepCopy, o as hasOwn$1, p as createCoreContext, q as clearDateTimeFormat, r as clearNumberFormat, s as isNumber, t as isMessageAST, A as AST_NODE_PROPS_KEYS, v as setAdditionalMeta, w as getFallbackContext, N as NOT_REOSLVED, x as fallbackWithLocaleChain, y as setFallbackContext, C as CORE_ERROR_CODES_EXTEND_POINT, z as parseTranslateArgs, B as translate, M as MISSING_RESOLVE_VALUE, E as parseDateTimeArgs, F as datetime, G as parseNumberArgs, H as number, I as isMessageFunction, J as NUMBER_FORMAT_OPTIONS_KEYS, K as DATETIME_FORMAT_OPTIONS_KEYS, L as registerMessageCompiler, O as registerMessageResolver, P as registerLocaleFallbacker, Q as getGlobalThis$1, R as setDevToolsHook, S as compile, T as resolveValue, U as on, V as off } from "./vendor-base.BHbH-Msk.js";
/**
* @vue/shared v3.5.28
...
function getLocaleMessages(locale, options) {
  ...
  const ret = isPlainObject$2(messages) ? messages : isArray$2(__i18n) ? create() : { [locale]: create() };
  if (isArray$2(__i18n)) {
...
function createComposer(options = {}) {
  ...
  const _fallbackLocale = _ref(
    // prettier-ignore
    __root && _inheritLocale ? __root.fallbackLocale.value : isString$1(options.fallbackLocale) || isArray$2(options.fallbackLocale) || isPlainObject$2(options.fallbackLocale) || options.fallbackLocale === false ? options.fallbackLocale : _locale.value
  );
...
function convertComposerOptions(options) {
  ...
  const fallbackLocale = isString$1(options.fallbackLocale) || isArray$2(options.fallbackLocale) || isPlainObject$2(options.fallbackLocale) || options.fallbackLocale === false ? options.fallbackLocale : locale;
...
function hasInstance() {
  return getCurrentInstance$1() !== null;
}
...
export {
  ...
  useIsIos as a7,
  clickoutside as a8,
  mousemoveoutside as a9,
  cloneVNode as aa,
  Text as ab,
  useMergedState as ac,
  useCompitable as ad,
  markRaw as ae,
  useKeyboard as af,
  onUnmounted as ag,
  ...
  useClicked as ai,
  useClickPosition as aj,
  useBreakpoints as ak,
