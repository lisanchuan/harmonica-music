import { ar as AutomationEventList, as as createSetValueCurveAutomationEvent, at as createSetValueAutomationEvent, au as createSetTargetAutomationEvent, av as createLinearRampToValueAutomationEvent, aw as createExponentialRampToValueAutomationEvent, ax as createCancelScheduledValuesAutomationEvent, ay as createCancelAndHoldAutomationEvent, az as __awaiter, aA as __decorate, aB as require$$2, aC as requireMidiFile } from "./vendor-base.BHbH-Msk.js";
...
const connectedSignals = /* @__PURE__ */ new WeakMap();
...
const workletName$2 = "feedback-comb-filter";
...
registerProcessor(workletName$2, feedbackCombFilter);
...
class Oscillator extends Source {
   ...
   * has stopped.
   */
  _cleanUpConnections(oscillator) {
    if (this.context.isOffline) {
      return;
    }
...
const workletName = "reverse-delay";
const reverseDelayWorklet = (
  /* javascript */
  `
...
function requireInstrument() {
  if (hasRequiredInstrument) return Instrument2;
  hasRequiredInstrument = 1;
  Object.defineProperty(Instrument2, "__esModule", { value: true });
  Instrument2.Instrument = void 0;
  ...
  Instrument2.Instrument = Instrument$12;
  return Instrument2;
}
var Note = {};
var hasRequiredNote;
...
function requireMidi() {
  ...
  hasRequiredMidi = 1;
  (function(exports$1) {
    var __awaiter2 = Midi && Midi.__awaiter || function(thisArg, _arguments, P, generator) {
